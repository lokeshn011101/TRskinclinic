  ...
  return (
    <div className="flex lg:flex-row flex-col justify-around items-center mx-auto lg:p-24">
      <div className="relative lg:w-1/4 lgg:w-7/12 lgg:mt-8">
        <Image layout="fill" src="/Gallery/one.png" alt="one" layout="fill" />
        <h2
      ...
      <div className="relative lg:w-1/4 lgg:w-7/12 lgg:mt-8">
        <Image layout="fill" src="/Gallery/two.png" alt="two" />
        <h2
      ...
      <div className="relative lg:w-1/4 lgg:w-7/12 lgg:mt-8">
        <Image layout="fill" src="/Gallery/three.png" alt="three" />
        <h2
